            ...
            <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
              <q-item>
                ...
                <q-item-section>
                  ...
                  <q-item-label caption>Medicines</q-item-label>
                </q-item-section>
              </q-item>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
            ...
            <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
              <q-item>
                ...
                <q-item-section>
                  ...
                  <q-item-label caption>Laboratory</q-item-label>
                </q-item-section>
              </q-item>
            </div>
            <div class="col-lg-3 col-md-3 col-xs-6 col-sm-6">
        ...
        <q-item>
          ...
          <q-item-section>
            ...
            <q-item-label caption class="text-black">
              Monitoring Your patients. Tracking sales, and shipping status here.
            </q-item-label>
          </q-item-section>
        </q-item>
      </q-card-section>
