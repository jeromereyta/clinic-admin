      ...
      <div class="col-3 rounded-borders q-px-xs">
        <q-card class="q-pa-xs custom_bg ">
          <q-item style="cursor: move;" class="q-pa-none text-white q-pa-sm rounded-borders">
            <q-item-section class="text-h6 text-weight-bolder text-color">IN LINE</q-item-section>
...
<!--            </q-item>-->
      ...
      <div class="col-3 q-px-xs">
        <q-card class="q-pa-xs custom_bg2 ">
          <q-item style="cursor: move;" class="q-pa-none text-white q-pa-sm">
            <q-item-section class="text-h6 text-weight-bolder text-color">CANCELLED
            </q-item-section>
            <q-item-section avatar>
              <q-icon name="more_vert" class="cursor-pointer">
                <q-menu transition-show="fade" transition-hide="fade">
    ...
    export default {
        ...
        data() {
            return {
                ...
                planned_task: [
                    {
                        title: 'Antonette Gibral',
                        label: '15 mins',
                        tags: [{name: 'Next ->', color: 'warning'}],
                        description: 'Consultation'
                    },
                    {
                        title: 'Jake Garcia',
                        label: '10 mins',
                        tags: [{name: 'waiting', color: 'info'}],
                ...
                wip_task: [
                  {
                    title: 'Antonette Gibral',
                    label: '15 mins',
                    tags: [{name: 'Ongoing', color: 'positive'}],
                    description: 'Consultation'
                  },
                  {
                    title: 'Jake Garcia',
                ...
                blocked_task: [
                    {
                        title: 'Joshua Antike',
                        label: '30 mins',
                        tags: [{name: 'Cancelled', color: 'negative'}],
                        description: 'Consultation'
                    },
                ],
                completed_task: [
                  {
                    title: 'Antonette Gibral',
                    label: '15 mins',
                    tags: [{name: 'Completed', color: 'positive'}],
                    description: 'Consultation'
                  },
                ],
